...
public class ClientController implements Serializable {
	...
	try{
                    Client clientBDD= this.ejbFacade.findByLogin( selected.getLoginClient() );
  
                if(selected.getMotDePasseClient().equals(clientBDD.getMotDePasseClient())) {
              
                    
                  
                HttpSession session=   (HttpSession)(FacesContext.getCurrentInstance().getExternalContext().getSession(true));  
                  clientBDD.setMotDePasseClient(null);
                session.setAttribute( "sessionClient", clientBDD);
                                 FacesContext.getCurrentInstance().getExternalContext().redirect(request.getContextPath()+"/espace_client/index.xhtml");                  
        ...
        HttpServletRequest request = (HttpServletRequest) context.getExternalContext().getRequest(); 
            ...
            session.invalidate();
                  ...
                  FacesContext.getCurrentInstance().getExternalContext().redirect(request.getContextPath()+"/loginClient.xhtml");                  
